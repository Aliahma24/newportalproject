    ...
    <div className="flex h-screen w-full bg-background overflow-hidden font-sans">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6 custom-scrollbar">
          ...
          {/* ROW 1: Next Class Card */}
          <div className="bg-card border border-border border-l-4 border-l-primary rounded-xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-sm">
            ...
            <div className="flex items-center gap-4 pr-0 md:pr-12 md:border-r border-border shrink-0">
               <img 
            ...
            <button className="w-full md:w-[160px] h-12 rounded-lg bg-primary text-primary-foreground font-bold flex items-center justify-center gap-2 hover:bg-primary/90 transition-all active:scale-[0.98] shrink-0 shadow-lg shadow-primary/20">
              <Video size={18} />
              Join Class
            </button>
          </div>
